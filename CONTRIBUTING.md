...
* 在 [GitHub](https://github.com/khs1994-docker/lnmp/fork) 上点击 `fork` 按钮将本仓库 fork 到自己的仓库，如 `yourname/lnmp`，然后 `clone` 到本地。
  ...
  ```bash
  $ git clone -b 24.11 git@github.com:yourname/lnmp.git
...
* 在 [GitHub](https://github.com/khs1994-docker/lnmp) 上提交 `Pull request`，注意请提交到 YY.MM(例如: `24.11`) 分支。
...
* 请定期更新自己仓库。
  ...
  $ git rebase upstream/24.11

  $ git push -f origin 24.11
  ```
