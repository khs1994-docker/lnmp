...
|[PHP-FPM](https://github.com/khs1994-docker/php-fpm)                      |`khs1994/php:7.2.14-fpm-alpine`  | **7.2.14**       |`Alpine:3.8`    |
|[Laravel](https://github.com/laravel/laravel)                             |`khs1994/php:7.2.14-composer-alpine`  | **5.7.x**       |`Alpine:3.8`    |
|[Composer](https://github.com/docker-library/docs/tree/master/composer)   |`khs1994/php:7.2.14-composer-alpine`  | **1.8.0**       |`Alpine:3.8`    |
|[PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer)              |`khs1994/php:7.2.14-composer-alpine`  | **2.14.0**      |`Alpine:3.8`    |
