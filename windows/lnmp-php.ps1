...
docker run -it --rm --mount type=bind,src=$PWD,target=/app --mount src=lnmp_composer_cache-data,target=/tmp/cache -e APP_ENV=development khs1994/php-fpm:7.2.3-alpine3.7 php $COMMAND
