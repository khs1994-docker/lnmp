...
$ lnmp-wsl-builder-php-rhel.sh 7.2.12 7.3.0RC5 7.3.0beta3

$ lnmp-wsl-builder-php-rhel.sh yum

$ lnmp-wsl-builder-php-rhel.sh 7.2.12 [--skipbuild] [tar] [rpm] [enable-ext]
...
if [ "$PHP_VERSION" = 'rpm' ];then PHP_VERSION=7.2.12 ; fi
