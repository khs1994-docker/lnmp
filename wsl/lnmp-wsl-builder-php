...
$ lnmp-wsl-builder-php.sh 7.2.12

$ lnmp-wsl-builder-php.sh apt

$ lnmp-wsl-builder-php.sh 7.3.0RC5 7.3.0beta3

$ lnmp-wsl-builder-php.sh 7.2.12 [--skipbuild] [tar] [deb] [enable-ext]

$ lnmp-wsl-builder-php.sh 7.2.12 arm64 tar [TODO]

$ lnmp-wsl-builder-php.sh 7.2.12 arm32 tar [TODO]
...
test "$PHP_VERSION" = 'apt' && PHP_VERSION=7.2.12
