...
ARG DEST_NAMESPACE
# fix me 必须替换为自己的配置文件
# ARG CONFIG_URL=https://gitee.com/khs1994-docker/lnmp/raw/24.11/dockerfile/sync/docker-image-sync-by-docker.json
...
ENV CONFIG_URL=https://github.com/khs1994-docker/lnmp/raw/24.11/dockerfile/sync/docker-image-sync-by-docker.json
