...
* 8.0.3-cli-alpine
* 8.0.3-fpm-alpine
* 8.0.3-unit-alpine         (based cli)
* 8.0.3-composer-alpine     (based fpm)
* 8.0.3-swoole-alpine       (based cli)
* 8.0.3-s6-alpine           (based fpm)

## Supported tags and respective `Dockerfile` links

* [`8.0.3-fpm-alpine` (8.0/fpm/Dockerfile)](https://github.com/khs1994-docker/php/blob/8.0.3/8.0/fpm/Dockerfile)

* [`7.4.16-fpm-alpine` (7.4/fpm/Dockerfile)](https://github.com/khs1994-docker/php/blob/8.0.3/7.4/fpm/Dockerfile)

* [`7.3.27-fpm-alpine` (7.3/fpm/Dockerfile)](https://github.com/khs1994-docker/php/blob/8.0.3/7.3/fpm/Dockerfile)

* [`7.2.34-fpm-alpine` (7.2/fpm/Dockerfile)](https://github.com/khs1994-docker/php/blob/8.0.3/7.2/fpm/Dockerfile)
...
| [![](https://images.microbadger.com/badges/version/library/php:7.4.16-fpm-alpine.svg)](https://microbadger.com/images/library/php:7.4.16-fpm-alpine "Get your own version badge on microbadger.com")       | [![](https://images.microbadger.com/badges/image/library/php:7.4.16-fpm-alpine.svg)](https://microbadger.com/images/library/php:7.4.16-fpm-alpine "Get your own image badge on microbadger.com")       |
| [![](https://images.microbadger.com/badges/version/khs1994/php:7.4.16-fpm-alpine.svg)](https://microbadger.com/images/khs1994/php:7.4.16-fpm-alpine "Get your own version badge on microbadger.com")       | [![](https://images.microbadger.com/badges/image/khs1994/php:7.4.16-fpm-alpine.svg)](https://microbadger.com/images/khs1994/php:7.4.16-fpm-alpine "Get your own image badge on microbadger.com")       |
| [![](https://images.microbadger.com/badges/version/library/php:8.0.3-fpm-alpine.svg)](https://microbadger.com/images/library/php:8.0.3-fpm-alpine "Get your own version badge on microbadger.com")       | [![](https://images.microbadger.com/badges/image/library/php:8.0.3-fpm-alpine.svg)](https://microbadger.com/images/library/php:8.0.3-fpm-alpine "Get your own image badge on microbadger.com")       |
| [![](https://images.microbadger.com/badges/version/khs1994/php:8.0.3-fpm-alpine.svg)](https://microbadger.com/images/khs1994/php:8.0.3-fpm-alpine "Get your own version badge on microbadger.com")       | [![](https://images.microbadger.com/badges/image/khs1994/php:8.0.3-fpm-alpine.svg)](https://microbadger.com/images/khs1994/php:8.0.3-fpm-alpine "Get your own image badge on microbadger.com")       |
...
* https://sources.debian.org/src/php7.4/7.4.16-1/debian/control/
