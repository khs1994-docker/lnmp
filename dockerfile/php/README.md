...
* 8.1.1-cli-alpine
* 8.1.1-fpm-alpine
* 8.1.1-unit-alpine         (based cli)
* 8.1.1-composer-alpine     (based fpm)
* 8.1.1-swoole-alpine       (based cli)
* 8.1.1-s6-alpine           (based fpm)
...
* [`7.3.33-fpm-alpine` (7.3/fpm/Dockerfile)](https://github.com/khs1994-docker/php/blob/8.1.1/7.3/fpm/Dockerfile)

* [`7.2.34-fpm-alpine` (7.2/fpm/Dockerfile)](https://github.com/khs1994-docker/php/blob/8.1.1/7.2/fpm/Dockerfile)
...
* https://sources.debian.org/src/php7.4/7.4.28-1+deb11u1/debian/control/

* https://sources.debian.org/src/php8.1/8.1.1-1/debian/control/
