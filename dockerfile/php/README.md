...
* 8.0.10-cli-alpine
* 8.0.10-fpm-alpine
* 8.0.10-unit-alpine         (based cli)
* 8.0.10-composer-alpine     (based fpm)
* 8.0.10-swoole-alpine       (based cli)
* 8.0.10-s6-alpine           (based fpm)

## Supported tags and respective `Dockerfile` links

* [`8.0.10-fpm-alpine` (8.0/fpm/Dockerfile)](https://github.com/khs1994-docker/php/blob/8.0.10/8.0/fpm/Dockerfile)

* [`7.4.23-fpm-alpine` (7.4/fpm/Dockerfile)](https://github.com/khs1994-docker/php/blob/8.0.10/7.4/fpm/Dockerfile)

* [`7.3.30-fpm-alpine` (7.3/fpm/Dockerfile)](https://github.com/khs1994-docker/php/blob/8.0.10/7.3/fpm/Dockerfile)

* [`7.2.34-fpm-alpine` (7.2/fpm/Dockerfile)](https://github.com/khs1994-docker/php/blob/8.0.10/7.2/fpm/Dockerfile)
...
* https://sources.debian.org/src/php7.4/7.4.23-1/debian/control/
