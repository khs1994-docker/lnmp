...
# 请将 1.25.0 替换为实际的 k8s 版本号
$ wsl -d wsl-k8s -- bash -xc 'cp -a kubernetes-release/release/v1.25.0-linux-amd64/kubernetes/server/bin/kube-{apiserver,controller-manager,scheduler} ${K8S_ROOT:?err}/bin'
```
