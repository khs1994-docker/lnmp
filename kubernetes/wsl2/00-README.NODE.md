...
# 请将 1.25.0 替换为实际的版本号
$ wsl -d wsl-k8s -- bash -xc 'cp -a kubernetes-release/release/v1.25.0-linux-amd64/kubernetes/server/bin/{kube-proxy,kubectl,kubelet,kubeadm,mounter} ${K8S_ROOT:?err}/bin'
