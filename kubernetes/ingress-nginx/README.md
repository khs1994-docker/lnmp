...
# 裸机 通过 nodeport
$ kubectl apply --kustomize addons/ingress-nginx/baremetal
$ kubectl apply -f addons/ingress-nginx/baremetal/service-nodeport.yaml 

# Docker 桌面版
$ kubectl apply --kustomize addons/ingress-nginx/cloud-generic
```
