...
complete -c lnmp-docker -n "__fish_use_subcommand" -f -a build             -d     'Build or rebuild your LNMP Docker Images (Only Support x86_64)'
complete -c lnmp-docker -n "__fish_use_subcommand" -f -a push              -d     'Pushes LNMP Docker Images to Docker Registory'
