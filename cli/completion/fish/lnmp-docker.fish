...
complete -c lnmp-docker -n "__fish_use_subcommand" -f -a init              -d      'Init a new lnmp-include package'
complete -c lnmp-docker -n "__fish_use_subcommand" -f -a add               -d      'Add new lnmp-include package'
complete -c lnmp-docker -n "__fish_use_subcommand" -f -a outdated          -d      'Shows a list of installed lnmp-include packages that have updates available'
complete -c lnmp-docker -n "__fish_use_subcommand" -f -a pkg-backup        -d      'Upload composer.json to GitHub Gist'
complete -c lnmp-docker -n "__fish_use_subcommand" -f -a pkg-update        -d      'Update lnmp-include package'
