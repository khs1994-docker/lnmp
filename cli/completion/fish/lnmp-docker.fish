...
complete -c lnmp-docker -n "__fish_use_subcommand" -f -a init              -d      'Init a new lrew package'
complete -c lnmp-docker -n "__fish_use_subcommand" -f -a add               -d      'Add new lrew package'
