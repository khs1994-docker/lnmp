...
complete -c lnmp-docker.sh -n "__fish_use_subcommand" -f -a registry-up       -d     'Up Docker Registry'
...
complete -c lnmp-docker.sh -n "__fish_use_subcommand" -f -a nfs               -d     'Up NFS Server'
