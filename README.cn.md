...
|[PHP-FPM](https://github.com/khs1994-docker/php)                          |`khs1994/php:8.0.7-fpm-alpine`     | **8.0.7**      |`alpine:3.13`    |
|[Composer](https://github.com/docker-library/docs/tree/master/composer)   |`khs1994/php:8.0.7-composer-alpine`| **2.1.3**     |`alpine:3.13`    |
...
|[PHPMyAdmin](https://github.com/docker-library/docs/tree/master/phpmyadmin)|`phpmyadmin:5.1.1`                | **5.1.1**       |`alpine:3.13`    |
