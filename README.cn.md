...
|[NGINX Unit](https://github.com/nginx/unit)                               |`khs1994/php:7.4.6-unit-alpine`| **1.18.0**             |`alpine:3.11`    |
...
|[Redis](https://github.com/docker-library/docs/tree/master/redis)         |`redis:6.0.4-alpine`        | **6.0.4**            |`alpine:3.12`    |
|[PHP-FPM](https://github.com/khs1994-docker/php)                      |`khs1994/php:7.4.6-fpm-alpine`  | **7.4.6**       |`alpine:3.11`    |
|[Composer](https://github.com/docker-library/docs/tree/master/composer)   |`khs1994/php:7.4.6-composer-alpine`  | **1.10.7**       |`alpine:3.11`    |
