...
|[PHP-FPM](https://github.com/khs1994-docker/php)                          |`khs1994/php:8.0.0-fpm-alpine`     | **8.0.0**      |`alpine:3.11`    |
|[Composer](https://github.com/docker-library/docs/tree/master/composer)   |`khs1994/php:8.0.0-composer-alpine`| **2.0.7**     |`alpine:3.11`    |
