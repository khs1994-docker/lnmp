...
|[MariaDB](https://github.com/docker-library/docs/tree/master/mariadb)     |`mariadb:10.4.4`            | **10.4.4**             |`Ubuntu:bionic` |
...
|[Memcached](https://github.com/docker-library/docs/tree/master/memcached) |`memcached:1.5.15-alpine`           | **1.5.15**       |`Alpine:3.9`    |
